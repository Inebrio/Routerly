...
:::tip
Store your router token in a Jupyter environment variable rather than hardcoding it. Add `export ROUTERLY_TOKEN=sk-rt-…` to your shell profile and read it with `os.environ["ROUTERLY_TOKEN"]`.
:::
