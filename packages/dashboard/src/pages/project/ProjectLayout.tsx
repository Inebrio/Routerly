...
import { ArrowLeft, Settings, Route, Users, FileText, Key, Shield, UserSearch, Bell } from 'lucide-react';
...
export function ProjectLayout() {
  ...
  const tabs = [
    ...
    { id: 'notifications', label: 'Notifications', icon: <Bell size={16} />, disabled: isNew },
  ];
