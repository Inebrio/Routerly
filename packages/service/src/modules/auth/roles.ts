...
export const BUILT_IN_ROLES: RoleConfig[] = [
  ...
  { id: 'viewer',   name: 'Viewer',   permissions: ['project:read', 'model:read', 'report:read', 'settings:read', 'token:read', 'audit:read', 'modules:read', 'connections:read', 'profiles:read', 'optimizers:read', 'experiments:read'] },
  { id: 'operator', name: 'Operator', permissions: ['project:read', 'project:write', 'model:read', 'model:write', 'report:read', 'user:read', 'settings:read', 'token:read', 'token:write', 'notification:write', 'modules:read', 'connections:read', 'connections:manage', 'profiles:read', 'profiles:manage', 'optimizers:read', 'optimizers:manage', 'experiments:read', 'experiments:manage'] },
];
