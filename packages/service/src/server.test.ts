...
describe('startServer', () => {
  ...
  // migrateUsageToNdjson() is the one exception: it runs directly in
  // startServer(), outside the kernel's best-effort catch, so a corrupted
  // legacy usage.json is fatal (EC2) — see RTR-06 B1 remediation.
