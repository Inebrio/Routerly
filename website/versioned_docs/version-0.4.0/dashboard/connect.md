...
**Connect app** sits at the bottom of the sidebar, right under **Settings**,
next to the other instance-level entries rather than in the working section
above. Or navigate to `/dashboard/connect` directly.
